...
@add_arg_table! s begin
    "--src", "-s"
        help = "source dir"
        arg_type = String
        default = "s3://lizz.ssd/datasets/hmdb51"
    "--dst", "-t"
        help = "target dir"
        arg_type = String
        default = "s3://lizz.ssd/datasets/hmdb51_flow"
    "--list", "-l"
        help = "list file"
        arg_type = String
        default = "hmdb51_full_list.txt"
    "--split"
...
writedlm("hmdb-flow-split$(split)_of_$(splits)-errors.log", errors)
