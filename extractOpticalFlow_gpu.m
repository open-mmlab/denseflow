...
if type ==0
    path2 = '/media/sdb/lmwang/data/UCF101/ucf101_flow_img_farn_gpu/';
elseif type ==1
    path2 = '/media/sdb/lmwang/data/UCF101/ucf101_flow_img_tvl1_gpu/';
else
    path2 = '/media/sdb/lmwang/data/UCF101/ucf101_flow_img_brox_gpu/';
end
...
for i = index
    ...
    for j = 1:length(filelist)
        ...
        cmd = sprintf('./denseFlow_gpu -f %s -x %s -y %s -i %s -b 20 -t %d -d %d',...
            file1,file2,file3,file4,type,device_id);
        system(cmd);
	end
	i
end
