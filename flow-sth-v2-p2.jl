...
@add_arg_table! s begin
    "--src", "-s"
        help = "source dir"
        arg_type = String
        default = "s3://lizz.ssd/datasets/something-something-v2"
    "--dst", "-t"
        help = "target dir"
        arg_type = String
        default = "s3://lizz.ssd/datasets/something-something-v2_flow_p2"
    "--list", "-l"
        help = "list file"
        arg_type = String
        default = "something-something-v2_full_list.txt"
    "--split"
...
writedlm("something-something-v2-flow-split$(split)_of_$(splits)-errors.log", errors)
