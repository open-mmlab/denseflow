...
@add_arg_table! s begin
    "--src", "-s"
        help = "source dir"
        arg_type = String
        default = "s3://lizz.ssd/datasets/ucf101"
    "--dst", "-t"
        help = "target dir"
        arg_type = String
        default = "s3://lizz.ssd/datasets/ucf101_flow"
    "--list", "-l"
        help = "list file"
        arg_type = String
        default = "ucf101_full_list.txt"
    "--split"
...
writedlm("ucf-flow-split$(split)_of_$(splits)-errors.log", errors)
